...
However, there can be trade-offs between functions, and efforts to maximize one function negatively impact another [@Zavaleta2010].
...
Over the past decades, severe declines in habitat quality and fish biomass have brought coral reef functioning to the forefront of scientific discourse [@Bellwood2019; @Brandl2019front].
However, our capacity to evaluate reef functioning primarily relies on static proxies of functions, such as live coral cover, standing stock biomass of reef fishes, or functional richness based on qualitative traits [e.g. @Cinner2020].
...
Biomass is the most commonly employed indicator of coral reef functioning [@Cinner2020; @Brandl2019front], and as can be expected from the cumulative nature of community-level functioning, we indeed observed a strong relationship between fish biomass and all five functions (Extended Data Fig. 1a-e, Extended Data Fig. 2).
...
Consequently, for a given value of standing stock biomass, no reef can yield above average values across all five functions.
...
Certain species or entire families tend to contribute more or less to a particular function, relative to their contribution to standing biomass (Fig. 3a; Extended Data Fig. 3,4).
Further, abundant species can impact rates of functioning at the community level [@Topor2019].
