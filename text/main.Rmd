...
**One Sentence Summary:** A global assessment of multiple ecosystem functions reveals critical trade-offs among functions in coral reefs.
...
Yet, their integrity of is threatened by a plethora of anthropogenic stressors [@Hughes2017].
...
However, our capacity to evaluate reef functioning relies on static proxies of functions, such as live coral cover, standing stock biomass of reef fishes, or functional richness based on qualitative traits [e.g. @Cinner2020].
Conversely, we know comparatively little about elemental fluxes and their drivers (but see [@Allgeier2016]), which constitutes a severe limitation to management [@Brandl2019front].
...
Biomass is the most commonly employed indicator of coral reef functioning [@Cinner2020; @Brandl2019front], and we indeed observed a strong relationship between fish biomass and all five functions (Extended Data Fig. 1a-e, Extended Data Fig. 2).
However, our analyses demonstrate that functions vary remarkably after accounting for biomass - functions of communities with similar biomass may differ with two orders of magnitude or more (i.e. biomass production, Extended Data Fig. 1a-f).
...
For example, phosphorus excretion and piscivory are higher in communities with large-bodied fishes that occupy high trophic levels (Extended Fig. 1g; See @Allgeier2014).
...
Thus, due to variations in organismal physiology and life-history traits [@Schiettekatte2020], fish community structure can significantly impact ecosystem-wide functioning [@Schramski2015].



Secondly, alongside features of community structure, functions may also be influenced by specific high-performing taxa.
Certain species tend to contribute more or less to a particular function, relative to their contribution to biomass (Fig. 3a; Extended Data Fig. 3,4).
...
However, the identity of these species varies dramatically (Fig. 3c).
While few high-performing taxa dominate functioning in each location, there are no species that are important across their entire range, and most species are locally important in at least one community.
Indeed, 70% of all species contributed disproportionally to a specific function in at least one ommunity.
