...
We then used a back-calculation procedure to estimate fish length at previous ages, modified to also quantify the uncertainty around the obtained length estimates using a Bayesian approach (fishgrowbot, ref).
