...
$$
\begin{array}{c} \mu_{\textrm{ExN,i}}  = (\beta0_{ExN}  +  \delta_{ExN, loc}  +  \delta_{ExN, site}) \\
...
\mu_{\textrm{Pisc,i}} = (\beta0_{Pisc} +  \delta_{Pisc, loc} +  \delta_{Pisc, site}) , \end{array}
$$
...
$$\begin{array}{c} \mu_{\textrm{ExN,i}} = (\beta0_{ExN} +  \delta_{ExN, loc} +  \delta_{ExN, site}) +{\beta1_{ExN}} {x_{log(biomass),i}} + {\beta2_{ExN}} {x_{sst,i}} \\
...
\mu_{\textrm{Pisc,i}} = (\beta0_{Pisc} +  \delta_{Pisc, loc} +  \delta_{Pisc, site}) +{\beta1_{Pisc}} {x_{log(biomass),i}} + {\beta2_{Pisc}} {x_{sst,i}} \end{array}
$$
...
$$\begin{array}{c} \mu_{\textrm{function,i}}  = \beta0_{function} + \beta1_{function} x_{log(biomass),i} + \beta2_{function} x_{sst,i}  + \beta3_{function} x_{richness,i}  + \beta4_{function} x_{size_m,i}  + \beta5_{function} x_{size_{2.5\%},i} +  \beta6_{function} x_{size_{97.5\%},i} + \\
\beta7_{function} x_{troph_m,i}  + \beta8_{function} x_{troph_{2.5\%},i} +  \beta9_{function} x_{troph_{97.5\%},i} + \beta10_{function} x_{imm_m,i}  + \beta11_{function} x_{imm_{2.5\%},i} +  \beta12_{function} x_{imm_{97.5\%},i} \end{array}$$
