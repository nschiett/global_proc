...
All models were fitted using brms (ref). The posterior distributions of model parameters were estimated using Markov chain Monte Carlo (MCMC) methods by  using four chains of 2,000 samples, including 1,000 samples as a warm‐up, meaning that a total of 4,000 samples were used to estimate posterior distributions. The convergence and fit of the models were verified by examining the Rhat, parameter trace plots, and posterior prediction plots. Posterior predictive checks for are provided in Supporting Information xxxx.
We ran all Bayesian reggression models using the R package *brms* which uses the stan algorithm.
The posterior distributions of model parameters were estimated using Markov chain Monte Carlo (MCMC) methods by  using four chains of 2,000 samples, including 1,000 samples as a warm‐up, meaning that a total of 4,000 samples were used to estimate posterior distributions.
